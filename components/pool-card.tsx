...
export function PoolCard({ pool, isDarkMode, onClick, isSelected }: PoolCardProps) {
  ...
  return (
    <Card
      className={`cursor-pointer transition-all w-full ${isDarkMode ? "bg-gray-900/50 border-gray-800 hover:border-purple-800" : "bg-white border-gray-200 hover:border-purple-300"
